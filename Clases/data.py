from aula import Aula as Salon
...
class Data:
    ...
    def __init__(self) -> None:
        ...
        curso2 = Curso('c2', 'Fundamentos de programacion', [self._profesores[2], self._profesores[0]], 30)
        curso3 = Curso('c3', 'Ecuaciones diferenciales', [self._profesores[0], self._profesores[1]], 30)
        curso4 = Curso('c4', 'Sistemas dgitales', [self._profesores[1], self._profesores[2]], 30)
        curso5 = Curso('c5', 'Estructura de datos', [self._profesores[2], self._profesores[0]], 30)
        curso6 = Curso('c6', 'Programación estructurada', [self._profesores[0], self._profesores[2]], 30)
        curso7 = Curso('c7', 'Fundamentos de física', [self._profesores[1], self._profesores[2]], 30)
        curso8 = Curso('c8', 'Fundamentos de programacion', [self._profesores[2], self._profesores[1]], 30)
        curso9 = Curso('c9', 'Logica matematica', [self._profesores[0], self._profesores[1]], 30)
        curso10 = Curso('c10', 'Programacion para internet', [self._profesores[0], self._profesores[1]], 30)
